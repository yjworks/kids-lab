...
window.KIDLAB_APPS = [
  ...
  { id: 'hanja',    name: '한자 놀이',   icon: '山', color: '#e7c6a5', desc: '기초 한자 31자 뜻·소리, 요일 한자, 필순 따라 쓰기, 천자문 16구절', cat: '우리말', how: '한자의 뜻과 소리를 익히고, 순서대로 따라 써요.' },
  { id: 'korean',   name: '우리말 탐험', icon: '💬', color: '#b9e8c8', desc: '학년별 낱말 뜻(초1~6), 속담, 사자성어', cat: '우리말', how: '낱말과 속담의 뜻을 읽고 알맞은 것을 골라요.' },
  { id: 'classic',  name: '고전 한 문장', icon: '📜', color: '#f3e3c3', desc: '논어·명심보감·탈무드 명구 22개, 오늘의 한 문장, 필사', cat: '우리말', how: '옛 책의 좋은 말을 읽고, 회색 글자 위에 따라 써요.' },
  ...
  { id: 'science',  name: '과학 탐험',   icon: '🔬', color: '#9be7a0', desc: '동물, 날씨, 우리 몸, 뜨고 가라앉기', cat: '과학·생활', how: '그림을 보고 맞는 답을 골라요.' },
  { id: 'daily',    name: '생활 습관',   icon: '🪥', color: '#ffe0b3', desc: '순서 맞추기, 옷 고르기, 정리하기', cat: '과학·생활', how: '하루 순서를 차례대로 골라요.' },
  { id: 'feelings', name: '마음 알기',   icon: '😊', color: '#ffc6ff', desc: '표정 읽기, 어떻게 할까요?', cat: '과학·생활', how: '표정을 보고 어떤 마음인지 골라요.' },
  { id: 'safety',   name: '안전 지킴이', icon: '🚦', color: '#ffb3a7', desc: '신호등, 위험한 것, 119', cat: '과학·생활', how: '위험한 것을 찾고, 신호등을 지켜요.' },
  { id: 'shop',     name: '가게 놀이',   icon: '🛒', color: '#ffe4a1', desc: '동전 세기, 물건 사기', cat: '과학·생활', how: '동전을 세어 물건 값을 내요.' },
  ...
  { id: 'coding',   name: '로봇 코딩',   icon: '🤖', color: '#cfd8ff', desc: '명령 블록으로 로봇 움직이기', cat: '두뇌·놀이', how: '명령을 차례로 놓고 시작을 눌러요.' },
  ...
  { id: 'diary',    name: '나의 하루',   icon: '📔', color: '#e2ece9', desc: '오늘 기분·날씨 기록, 달력', cat: '과학·생활', how: '오늘 기분과 날씨를 골라 기록해요.' },
